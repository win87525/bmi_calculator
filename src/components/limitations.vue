    ...
    <section>
        <div>
            ...
            <p>Although BMI is often a practical indicator of healthy weight, it is not suited for every person.
                ...
                not be beneficial to use.</p>
        </div>
        <div>
            <div class="gender">
                <div>
                    <img src="/src/assets/img/icon-gender.svg" alt="">
                    <h4>Gender</h4>
                </div>
                <p>The development and body fat composition of girls and boys vary with age. Consequently, a child's age
                    and gender are considered when evaluating their BMI.</p>
            </div>
            <div class="age">
                <div>
                    <img src="/src/assets/img/icon-age.svg" alt="">
                    <h4>Age</h4>
                </div>
            ...
            <div class="muscle">
                <div>
                    <img src="/src/assets/img/icon-muscle.svg" alt="">
                    <h4>Muscle</h4>
                </div>
            ...
            <div class="pregnancy">
                <div>
                    <img src="/src/assets/img/icon-pregnancy.svg" alt="">
                    <h4>Pregnancy</h4>
                </div>
            ...
            <div class="race">
                <div>
                    <img src="/src/assets/img/icon-race.svg" alt="">
                    <h4>Race</h4>
                </div>
...
<style scoped>
@import '/src//assets/css/limitations.css';
</style>